...
#include "vda5050_msgs/msg/detail/agv_action__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const vda5050_msgs::msg::ActionParameterDefinition &,
...
cdr_serialize(
  const vda5050_msgs::msg::AGVAction & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  vda5050_msgs::msg::AGVAction & ros_message)
{
  // Member: action_type
  cdr >> ros_message.action_type;
  ...
  size_t current_alignment)
{
  ...
  // Member: action_scopes
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += padding +
        eprosima::fastcdr::Cdr::alignment(current_alignment, padding) +
        (ros_message.action_scopes[index].size() + 1);
    }
  }
  // Member: action_parameters
  {
  ...
  size_t current_alignment)
{
  ...
  // Member: action_parameters
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        vda5050_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_ActionParameterDefinition(
  ...
  if (is_plain) {
    ...
    using DataType = vda5050_msgs::msg::AGVAction;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const vda5050_msgs::msg::AGVAction *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<vda5050_msgs::msg::AGVAction *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _AGVAction__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const vda5050_msgs::msg::AGVAction *>(
...
static size_t _AGVAction__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_AGVAction(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _AGVAction__callbacks = {
  "vda5050_msgs::msg",
  "AGVAction",
...
static rosidl_message_type_support_t _AGVAction__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_AGVAction__callbacks,
...
{
  return &vda5050_msgs::msg::typesupport_fastrtps_cpp::_AGVAction__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vda5050_msgs, msg, AGVAction)() {
  return &vda5050_msgs::msg::typesupport_fastrtps_cpp::_AGVAction__handle;
}
