...
#include "vda5050_msgs/msg/detail/header__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const vda5050_msgs::msg::Header & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  vda5050_msgs::msg::Header & ros_message)
{
  // Member: header_id
  cdr >> ros_message.header_id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vda5050_msgs::msg::Header;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const vda5050_msgs::msg::Header *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<vda5050_msgs::msg::Header *>(
    untyped_ros_message);
...
get_message_type_support_handle<vda5050_msgs::msg::Header>()
{
  return &vda5050_msgs::msg::typesupport_fastrtps_cpp::_Header__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vda5050_msgs, msg, Header)() {
  return &vda5050_msgs::msg::typesupport_fastrtps_cpp::_Header__handle;
}
