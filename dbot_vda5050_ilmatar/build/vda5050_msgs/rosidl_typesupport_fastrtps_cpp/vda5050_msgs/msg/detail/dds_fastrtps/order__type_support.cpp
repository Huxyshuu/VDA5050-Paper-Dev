...
#include "vda5050_msgs/msg/detail/order__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const vda5050_msgs::msg::Order & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  vda5050_msgs::msg::Order & ros_message)
{
  // Member: header_id
  cdr >> ros_message.header_id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vda5050_msgs::msg::Order;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const vda5050_msgs::msg::Order *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<vda5050_msgs::msg::Order *>(
    untyped_ros_message);
...
{
  return &vda5050_msgs::msg::typesupport_fastrtps_cpp::_Order__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vda5050_msgs, msg, Order)() {
  return &vda5050_msgs::msg::typesupport_fastrtps_cpp::_Order__handle;
}
