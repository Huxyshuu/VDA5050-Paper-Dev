...
#include "vda5050_msgs/msg/detail/order_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const vda5050_msgs::msg::NodeState &,
...
{
bool cdr_serialize(
  const vda5050_msgs::msg::EdgeState &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
{
bool cdr_serialize(
  const vda5050_msgs::msg::BatteryState &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
{
bool cdr_serialize(
  const vda5050_msgs::msg::SafetyState &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const vda5050_msgs::msg::OrderState & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: edge_states
  {
    ...
    for (size_t i = 0; i < size; i++) {
      vda5050_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
        ros_message.edge_states[i],
        cdr);
    }
  }
  // Member: agv_position
  vda5050_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.agv_position,
    cdr);
  // Member: velocity
  vda5050_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
  ...
  // Member: new_base_request
  cdr << (ros_message.new_base_request ? true : false);
  ...
  // Member: action_states
  {
    ...
    for (size_t i = 0; i < size; i++) {
      vda5050_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
        ros_message.action_states[i],
        cdr);
    }
  }
  // Member: battery_state
  vda5050_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.battery_state,
    cdr);
  ...
  // Member: informations
  {
    ...
    for (size_t i = 0; i < size; i++) {
      vda5050_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
        ros_message.informations[i],
        cdr);
    }
  }
  // Member: safety_state
  vda5050_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.safety_state,
    cdr);
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  vda5050_msgs::msg::OrderState & ros_message)
{
  // Member: header_id
  cdr >> ros_message.header_id;
  ...
  // Member: node_states
  {
    ...
    ros_message.node_states.resize(size);
    for (size_t i = 0; i < size; i++) {
      vda5050_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.node_states[i]);
    }
  }
  ...
  // Member: edge_states
  {
    ...
    cdr >> cdrSize;
    size_t size = static_cast<size_t>(cdrSize);
    ros_message.edge_states.resize(size);
    for (size_t i = 0; i < size; i++) {
      vda5050_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.edge_states[i]);
    }
  }
  ...
  // Member: loads
  {
    ...
    cdr >> cdrSize;
    size_t size = static_cast<size_t>(cdrSize);
    ros_message.loads.resize(size);
    for (size_t i = 0; i < size; i++) {
      vda5050_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.loads[i]);
    }
  }
  ...
  // Member: new_base_request
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message.new_base_request = tmp ? true : false;
  }
  ...
  // Member: action_states
  {
    ...
    cdr >> cdrSize;
    size_t size = static_cast<size_t>(cdrSize);
    ros_message.action_states.resize(size);
    for (size_t i = 0; i < size; i++) {
      vda5050_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.action_states[i]);
    }
  }
  ...
  // Member: informations
  {
    ...
    cdr >> cdrSize;
    size_t size = static_cast<size_t>(cdrSize);
    ros_message.informations.resize(size);
    for (size_t i = 0; i < size; i++) {
      vda5050_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.informations[i]);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: node_states
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ...
        ros_message.node_states[index], current_alignment);
    }
  }
  // Member: edge_states
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        vda5050_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
        ros_message.edge_states[index], current_alignment);
    }
  }
  // Member: agv_position
  ...
  // Member: loads
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        vda5050_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
        ros_message.loads[index], current_alignment);
    }
  }
  // Member: driving
  {
  ...
  // Member: new_base_request
  {
    size_t item_size = sizeof(ros_message.new_base_request);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: distance_since_last_node
  ...
  // Member: action_states
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        vda5050_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
        ros_message.action_states[index], current_alignment);
    }
  }
  // Member: battery_state
  ...
  // Member: informations
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        vda5050_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
        ros_message.informations[index], current_alignment);
    }
  }
  // Member: safety_state
  ...
  size_t current_alignment)
{
  ...
  // Member: node_states
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        vda5050_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_NodeState(
  ...
  // Member: edge_states
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        vda5050_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_EdgeState(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: loads
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        vda5050_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Load(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: battery_state
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        vda5050_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_BatteryState(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: errors
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        vda5050_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Error(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: informations
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        vda5050_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Info(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: safety_state
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        vda5050_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_SafetyState(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = vda5050_msgs::msg::OrderState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const vda5050_msgs::msg::OrderState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<vda5050_msgs::msg::OrderState *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _OrderState__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const vda5050_msgs::msg::OrderState *>(
...
static size_t _OrderState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_OrderState(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _OrderState__callbacks = {
  "vda5050_msgs::msg",
  "OrderState",
...
static rosidl_message_type_support_t _OrderState__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_OrderState__callbacks,
...
{
  return &vda5050_msgs::msg::typesupport_fastrtps_cpp::_OrderState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vda5050_msgs, msg, OrderState)() {
  return &vda5050_msgs::msg::typesupport_fastrtps_cpp::_OrderState__handle;
}
