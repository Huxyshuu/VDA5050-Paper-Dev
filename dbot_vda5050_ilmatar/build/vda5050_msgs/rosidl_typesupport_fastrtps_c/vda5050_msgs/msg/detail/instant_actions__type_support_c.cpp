...
#include "vda5050_msgs/msg/detail/instant_actions__rosidl_typesupport_fastrtps_c.h"
...
using _InstantActions__ros_msg_type = vda5050_msgs__msg__InstantActions;

static bool _InstantActions__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _InstantActions__ros_msg_type * ros_message = static_cast<const _InstantActions__ros_msg_type *>(untyped_ros_message);
...
static bool _InstantActions__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _InstantActions__ros_msg_type * ros_message = static_cast<_InstantActions__ros_msg_type *>(untyped_ros_message);
  // Field name: header_id
  {
    cdr >> ros_message->header_id;
  }
...
size_t get_serialized_size_vda5050_msgs__msg__InstantActions(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _InstantActions__ros_msg_type * ros_message = static_cast<const _InstantActions__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _InstantActions__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_vda5050_msgs__msg__InstantActions(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vda5050_msgs
size_t max_serialized_size_vda5050_msgs__msg__InstantActions(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vda5050_msgs__msg__InstantActions;
    is_plain =
      (
...
static size_t _InstantActions__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_vda5050_msgs__msg__InstantActions(
...
static message_type_support_callbacks_t __callbacks_InstantActions = {
  "vda5050_msgs::msg",
  "InstantActions",
  _InstantActions__cdr_serialize,
  _InstantActions__cdr_deserialize,
  _InstantActions__get_serialized_size,
  _InstantActions__max_serialized_size
};

static rosidl_message_type_support_t _InstantActions__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_InstantActions,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vda5050_msgs, msg, InstantActions)() {
  return &_InstantActions__type_support;
}
