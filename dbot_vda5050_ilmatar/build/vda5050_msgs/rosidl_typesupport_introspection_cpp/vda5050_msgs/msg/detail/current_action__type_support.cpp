...
static const ::rosidl_typesupport_introspection_cpp::MessageMember CurrentAction_message_member_array[5] = {
  {
    "action_id",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vda5050_msgs::msg::CurrentAction, action_type),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
