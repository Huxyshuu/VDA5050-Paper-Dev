...
class Metaclass_Trajectory(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from vda5050_msgs.msg import ControlPoint
    ...
    @property
    def DEGREE__DEFAULT(cls):
        """Return default value for message field 'degree'."""
        return 1.0
...
class Trajectory(metaclass=Metaclass_Trajectory):
    ...
    _fields_and_field_types = {
        'degree': 'double',
        'knot_vector': 'sequence<double>',
        'control_points': 'sequence<vda5050_msgs/ControlPoint>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('double'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.BasicType('double')),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['vda5050_msgs', 'msg'], 'ControlPoint')),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        self.degree = kwargs.get(
            'degree', Trajectory.DEGREE__DEFAULT)
        self.knot_vector = array.array('d', kwargs.get('knot_vector', []))
    ...
    def __eq__(self, other):
        ...
        if self.degree != other.degree:
            return False
        if self.knot_vector != other.knot_vector:
            return False
    ...
    def knot_vector(self, value):
        if isinstance(value, array.array):
            assert value.typecode == 'd', \
                "The 'knot_vector' array.array() must have the type code of 'd'"
        ...
        if __debug__:
            ...
            assert \
                ...
                "The 'knot_vector' field must be a set or sequence and each value of type 'float' and each double in [-.000000, .000000]"
        self._knot_vector = array.array('d', value)
