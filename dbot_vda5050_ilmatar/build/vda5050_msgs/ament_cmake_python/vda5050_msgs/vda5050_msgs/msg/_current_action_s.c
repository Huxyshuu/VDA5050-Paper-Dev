...
bool vda5050_msgs__msg__current_action__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vda5050_msgs.msg._current_action.CurrentAction", full_classname_dest, 46) == 0);
  }
  vda5050_msgs__msg__CurrentAction * ros_message = _ros_message;
  {  // action_id
  ...
  {  // action_status
    PyObject * field = PyObject_GetAttrString(_pymsg, "action_status");
    if (!field) {
      return false;
    }
    assert(PyUnicode_Check(field));
    ...
    rosidl_runtime_c__String__assign(&ros_message->action_status, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
  {  // result_description
...
{
  /* NOTE(esteve): Call constructor of CurrentAction */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("vda5050_msgs.msg._current_action");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CurrentAction");
  ...
  vda5050_msgs__msg__CurrentAction * ros_message = (vda5050_msgs__msg__CurrentAction *)raw_ros_message;
  {  // action_id
    PyObject * field = NULL;
  ...
  {  // action_status
    PyObject * field = NULL;
    field = PyUnicode_DecodeUTF8(
      ros_message->action_status.data,
      strlen(ros_message->action_status.data),
      "replace");
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "action_status", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
