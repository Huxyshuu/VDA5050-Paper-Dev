...
bool vda5050_msgs__msg__node_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vda5050_msgs.msg._node_state.NodeState", full_classname_dest, 38) == 0);
  }
  vda5050_msgs__msg__NodeState * ros_message = _ros_message;
  {  // node_id
...
PyObject * vda5050_msgs__msg__node_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("vda5050_msgs.msg._node_state");
  ...
  vda5050_msgs__msg__NodeState * ros_message = (vda5050_msgs__msg__NodeState *)raw_ros_message;
  {  // node_id
    PyObject * field = NULL;
