...
bool dbot_custom_msgs__msg__wheel_encoder__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dbot_custom_msgs.msg._wheel_encoder.WheelEncoder", full_classname_dest, 48) == 0);
  }
  dbot_custom_msgs__msg__WheelEncoder * ros_message = _ros_message;
  {  // header
...
PyObject * dbot_custom_msgs__msg__wheel_encoder__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("dbot_custom_msgs.msg._wheel_encoder");
