...
def generate_launch_description():
    ...
    map_file = LaunchConfiguration('map', default='/home/dbot2/dbot_vda5050_ilmatar/src/vda_dbot_nav_slam/maps/clean_df_map.yaml')
    params_file = LaunchConfiguration('params_file', default='/home/dbot2/dbot_vda5050_ilmatar/src/vda_dbot_nav_slam/config/nav2_params.yaml')
    ...
    ld.add_action(TimerAction(period=1.0, actions=[tf2_dbot_launch]))  # Wait 5 seconds before launching tf2_dbot
