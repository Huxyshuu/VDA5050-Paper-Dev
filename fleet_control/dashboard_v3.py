...
class DashboardController:
    ...
    def _benchmark_projection(self) -> Dict[str, Any]:
        """Project the three Laptop timing events and one trial-outcome record."""
        ...
        required_native = {"COMMAND_ISSUED", "COMMAND_ACK_RECEIVED", "COMMAND_RESULT_RECEIVED", "TRIAL_FINISHED"}
            ...
            trial_status.append(
                {
                    ...
                    "ack_ms": next((e.get("elapsed_from_command_ms") for e in projected
                                    if e.get("trial_id") == trial_id and e.get("event_type") == "COMMAND_ACK_RECEIVED"), None),
                    "completion_ms": next((e.get("elapsed_from_command_ms") for e in projected
                                           if e.get("trial_id") == trial_id and e.get("event_type") == "COMMAND_RESULT_RECEIVED"), None),
