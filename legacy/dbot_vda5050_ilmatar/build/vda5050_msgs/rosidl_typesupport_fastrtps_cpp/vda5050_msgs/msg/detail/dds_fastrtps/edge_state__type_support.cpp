...
#include "vda5050_msgs/msg/detail/edge_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const vda5050_msgs::msg::EdgeState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  vda5050_msgs::msg::EdgeState & ros_message)
{
  // Member: edge_id
  cdr >> ros_message.edge_id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vda5050_msgs::msg::EdgeState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const vda5050_msgs::msg::EdgeState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<vda5050_msgs::msg::EdgeState *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _EdgeState__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const vda5050_msgs::msg::EdgeState *>(
...
static size_t _EdgeState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_EdgeState(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _EdgeState__callbacks = {
  "vda5050_msgs::msg",
  "EdgeState",
...
static rosidl_message_type_support_t _EdgeState__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_EdgeState__callbacks,
...
get_message_type_support_handle<vda5050_msgs::msg::EdgeState>()
{
  return &vda5050_msgs::msg::typesupport_fastrtps_cpp::_EdgeState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vda5050_msgs, msg, EdgeState)() {
  return &vda5050_msgs::msg::typesupport_fastrtps_cpp::_EdgeState__handle;
}
