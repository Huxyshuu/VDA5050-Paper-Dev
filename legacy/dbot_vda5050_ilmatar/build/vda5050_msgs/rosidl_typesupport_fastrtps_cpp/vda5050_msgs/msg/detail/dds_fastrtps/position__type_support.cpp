...
#include "vda5050_msgs/msg/detail/position__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const vda5050_msgs::msg::Position & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  vda5050_msgs::msg::Position & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vda5050_msgs::msg::Position;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const vda5050_msgs::msg::Position *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<vda5050_msgs::msg::Position *>(
    untyped_ros_message);
...
get_message_type_support_handle<vda5050_msgs::msg::Position>()
{
  return &vda5050_msgs::msg::typesupport_fastrtps_cpp::_Position__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vda5050_msgs, msg, Position)() {
  return &vda5050_msgs::msg::typesupport_fastrtps_cpp::_Position__handle;
}
