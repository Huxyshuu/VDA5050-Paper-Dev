...
#include "dbot_custom_msgs/msg/detail/wheel_encoder__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dbot_custom_msgs::msg::WheelEncoder;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const dbot_custom_msgs::msg::WheelEncoder *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dbot_custom_msgs::msg::WheelEncoder *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_dbot_custom_msgs
const rosidl_message_type_support_t *
get_message_type_support_handle<dbot_custom_msgs::msg::WheelEncoder>()
{
  return &dbot_custom_msgs::msg::typesupport_fastrtps_cpp::_WheelEncoder__handle;
}
