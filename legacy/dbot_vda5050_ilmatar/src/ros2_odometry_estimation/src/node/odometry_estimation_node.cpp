...
void OdometryEstimator::handleRightWheelInput(const std_msgs::msg::Float64::SharedPtr rpm_right)
{
  rpms_right_.push_back(rpm_right->data);
}

void OdometryEstimator::handleLeftWheelInput(const std_msgs::msg::Float64::SharedPtr rpm_left)
{
