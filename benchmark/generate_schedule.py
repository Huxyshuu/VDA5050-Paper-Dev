...
def build_rows(device: str, pairs: int, seed: int):
...
def main() -> None:
    ...
    parser.add_argument("--device", choices=("rox", "crane"), required=True)
    ...
    rows = build_rows(args.device, args.pairs, args.seed)
